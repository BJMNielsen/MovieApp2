...
export default function PersonScreen() {
  ...
  const [person, setPerson] = useState({}); // indeholder detaljer om personen
  ...
  return (
    ...
    >
      ...
      {/* Person details */}
      {
        // when loading is true we show loading screen, otherwise we show the person view.
        loading ? (
          <Loading />
        ) : (
          <View>
            ...
            <View className="mx-0 p-3 mt-6 flex-row justify-between items-center bg-neutral-700 rounded-full">
